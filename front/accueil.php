...
<body class="bg-white rounded ">
    <div class="flex bg-black rounded shadow-xl h-18 px-6 justify-between fixed z-50 left-0 right-0 top-0"> 
        <div class="flex items-center">
            <img src="assets/dDDunia-removebg-preview.png" alt="Mon logo" class="w-24 h-16 ">
    ...
    <div class=" bg-cover bg-center h-screen flex flex-col text-white items-center pt-20 px-56 text-center gap-y-6 " style="background-image: url('assets/hector-j-rivas-1FxMET2U5dU-unsplash.jpg');">
        <div class="text-5xl font-semibold pb-4">Lorem Ipsum</div>
        <div class="leading-7">Lorem ipsum dolor sit amet consectetur adipisicing elit.
